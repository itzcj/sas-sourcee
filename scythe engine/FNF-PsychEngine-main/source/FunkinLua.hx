...
class FunkinLua {
	...
	public function new(script:String) {
		...
		#end
		// #end
		Lua_helper.add_callback(lua, "noteTweenXS", function(tag:String, note:Int, value:Dynamic, duration:Float, ease:String) {
			cancelTween(tag);
			if(note < 0) note = 0;
		...
		Lua_helper.add_callback(lua, "noteTweenYS", function(tag:String, note:Int, value:Dynamic, duration:Float, ease:String) {
			cancelTween(tag);
			if(note < 0) note = 0;
			var testicle:StrumNote = PlayState.instance.strumLineNotes.members[note % PlayState.instance.strumLineNotes.length];
		...
		Lua_helper.add_callback(lua, "noteXSquish", function(note:Int, value:Dynamic) {
			
			if(note < 0) note = 0;
			var testicle:StrumNote = PlayState.instance.strumLineNotes.members[note % PlayState.instance.strumLineNotes.length];

			if(testicle != null) {
				testicle.scale.x = value;
			}
			
		});
		Lua_helper.add_callback(lua, "noteYSquish", function(note:Int, value:Dynamic) {
			
			if(note < 0) note = 0;
			var testicle:StrumNote = PlayState.instance.strumLineNotes.members[note % PlayState.instance.strumLineNotes.length];

			if(testicle != null) {
				testicle.scale.y = value;
			}
			
		});
		Lua_helper.add_callback(lua, "addnoteXSquish", function(note:Int, value:Dynamic) {
		...
		Lua_helper.add_callback(lua, "addnoteYSquish", function(note:Int, value:Dynamic) {
		...
		Lua_helper.add_callback(lua, "noteX", function(note:Int, value:Dynamic) {
		...
		Lua_helper.add_callback(lua, "addNoteX", function(note:Int, value:Dynamic) {
		...
		Lua_helper.add_callback(lua, "noteY", function(note:Int, value:Dynamic) {
		...
		Lua_helper.add_callback(lua, "addNoteY", function(note:Int, value:Dynamic) {
		...
		//MAKE A NOTE ANGLE, NOTE X/Y, AND MORE

		Lua_helper.add_callback(lua, "noteAngle", function(note:Int, value:Dynamic) {
			
			if(note < 0) note = 0;
			var testicle:StrumNote = PlayState.instance.strumLineNotes.members[note % PlayState.instance.strumLineNotes.length];

			if(testicle != null) {
				testicle.angle = value;
			}
			
		});

		Lua_helper.add_callback(lua, "addNoteAngle", function(note:Int, value:Dynamic) {
